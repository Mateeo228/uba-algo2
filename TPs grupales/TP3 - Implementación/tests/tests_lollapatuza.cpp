...
//#-----------------------------------------------------------------
//4 tests creados por el grupo

TEST_F(LollaTest, ningun_puesto_vende_el_item) {
    FachadaLollapatuza l(personas, puestos);
    //El item 12 no está en el menú de ningún puesto.
    EXPECT_EQ(l.menorStock(12), 2);
}

TEST_F(LollaTest, hackear_todos_los_items_de_una_persona) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(4, 5, 3, 6);
    EXPECT_EQ(l.gastoTotal(4), 7500);
    EXPECT_EQ(l.gastoEnPuesto(6, 4), 7500);
    EXPECT_EQ(l.mayorGastador(), 4);
    EXPECT_EQ(l.stockEnPuesto(6, 5), 22);
...
TEST_F(LollaTest, hackear_mayor_gasto_y_que_deje_de_serlo) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(4, 5, 2, 6);
    l.registrarCompra(8, 7, 2, 6);
    EXPECT_EQ(l.gastoTotal(4), 5000);
    EXPECT_EQ(l.gastoEnPuesto(6, 4), 5000);
    EXPECT_EQ(l.gastoTotal(8), 4000);
    EXPECT_EQ(l.gastoEnPuesto(6, 8), 4000);
    EXPECT_EQ(l.mayorGastador(), 4);
...
TEST_F(LollaTest, no_hackear_la_de_mayor_gasto) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(4, 5, 3, 6);
    l.registrarCompra(8, 7, 3, 6);
    l.registrarCompra(2, 7, 2, 6);
    EXPECT_EQ(l.gastoTotal(4), 7500);
    EXPECT_EQ(l.gastoEnPuesto(6, 4), 7500);
    EXPECT_EQ(l.gastoTotal(8), 6000);
    EXPECT_EQ(l.gastoEnPuesto(6, 8), 6000);
    EXPECT_EQ(l.gastoTotal(2), 4000);
    EXPECT_EQ(l.gastoEnPuesto(6, 2), 4000);
    EXPECT_EQ(l.mayorGastador(), 4);
    ...
    EXPECT_EQ(l.gastoTotal(4), 7500);
    EXPECT_EQ(l.gastoEnPuesto(6, 4), 7500);
    EXPECT_EQ(l.gastoTotal(8), 2000);
    EXPECT_EQ(l.gastoEnPuesto(6, 8), 2000);
    EXPECT_EQ(l.gastoTotal(2), 4000);
    EXPECT_EQ(l.gastoEnPuesto(6, 2), 4000);
    EXPECT_EQ(l.mayorGastador(), 4);
}